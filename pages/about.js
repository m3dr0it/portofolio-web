    ...
    <Layout home>
      ...
      <ol className="relative border-l border-gray-200 dark:border-gray-700">
            <li className="mb-10 ml-4">
                ...
                <h3 className="text-lg font-semibold ">Java Developer At PT. IFG Life </h3>
                ...
                <p  className="text-base font-normal">Tech Stack : Java ( Quarkus ), PostgreSQL, Kafka, Kong API Gateway</p>
            </li> 
            <li className="mb-10 ml-4">
                <div className="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                <time className="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">September 2022 - Desember 2022</time>
                <h3 className="text-lg font-semibold ">Freelance Node Js Developer At PT. Lestari Elektronik Otomasi </h3>
                ...
                <p  className="text-base font-normal">Tech Stack : Node JS (Express), MySQL, Socket.io</p>
            </li> 
            <li className="mb-10 ml-4">
                <div className="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                <time className="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">Januari 2022 - September 2022</time>
                <h3 className="text-lg font-semibold ">Java Developer At PT. Fastana Logistik Indonesia</h3>
                ...
                <p  className="text-base font-normal">Tech Stack : Java (Springboot), PostgreSQL, Redis, Kafka</p>
            </li> 
            <li className="mb-10 ml-4">
                <div className="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                <time className="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">May 2021 - Desember 2021</time>
                <h3 className="text-lg font-semibold ">Java Developer At PT. Mcash Integrasi</h3>
            ...
            <li className="mb-10 ml-4">
                ...
                <h3 className="text-lg font-semibold ">Fullstack Developer at PT. Code Development Indonesia</h3>
                ...
                <p  className="text-base font-normal">Tech Stack : Node Js, React Js, PostgreSQL</p>
            </li>
            <li className="mb-10 ml-4">
                <div className="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                <time className="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">September 2019 - Januari 2021</time>
                <h3 className="text-lg font-semibold ">Network Operation Center Engineer at PT. Lima Menara Bintang</h3>
            ...
            <li className="mb-10 ml-4">
                ...
                <h3 className="text-lg font-semibold">Graduated From Politechnic State Of Bandung</h3>
