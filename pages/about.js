    ...
    <Layout home>
      ...
      <ol class="relative border-l border-gray-200 dark:border-gray-700">
            <li class="mb-10 ml-4">
                ...
                <p class="text-base font-normal text-gray-500 dark:text-gray-400">Develop Payment Module for Insurance Company, Payment Module Integrated to many Payment Gateway, 
                and each payment routes/directed to which payment gateway that has cheapest fee and best availability </p>
                <p  class="text-base font-normal">Tech Stack : Java ( Quarkus ), PostgreSQL, Kafka, Kong API Gateway</p>
            </li> 
            <li class="mb-10 ml-4">
                <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                ...
                <p class="text-base font-normal text-gray-500 dark:text-gray-400">Application act as middleware for Machines in Production Factory, application provides monitor machine performance and maintenance management</p>
                <p  class="text-base font-normal">Tech Stack : Node JS (Express), MySQL, Socket.io</p>
            </li> 
            <li class="mb-10 ml-4">
                <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                ...
                <p class="text-base font-normal text-gray-500 dark:text-gray-400">Logistic ECommerce Application, Help  Logistic Company find suitable partner and improve their bussiness. 
                Application provides variety feature, such as Company Contract, Multipick Shipment, Multidrop Shipment </p>
                <p  class="text-base font-normal">Tech Stack : Java (Springboot), PostgreSQL, Redis, Kafka</p>
            </li> 
            <li class="mb-10 ml-4">
                <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                ...
                <p class="text-base font-normal text-gray-500 dark:text-gray-400">White Label Logistic ECommerce Application, Help  Logistic Company find suitable partner and improve their bussiness</p>
                <p  class="text-base font-normal">Tech Stack : Java (Springboot), PostgreSQL, Redis, Kafka</p>
            </li>                
            <li class="mb-10 ml-4">
                <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                ...
                <p  class="text-base font-normal">Tech Stack : Node Js, React Js, PostgreSQL</p>
            </li>
            <li class="mb-10 ml-4">
                <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                ...
                <p class="text-base font-normal text-gray-500 dark:text-gray-400">Monitor and control large computer networks from a central location. I responsible for alarm response, ticketing and network troubleshooting</p>
            </li>
            <li class="mb-10 ml-4">
                <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
